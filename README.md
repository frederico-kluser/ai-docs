...
- [🔧 CLAUDE.md para Novos Projetos VIBE](./claude-template-new-vibe-projects.md) - Template para guiar o Claude Code quando
  trabalhando com novos projetos usando a arquitetura VIBE.
- [🔧 CLAUDE.md para Projetos Existentes](./claude-template-existing-projects.md) - Template para guiar o Claude Code quando
  trabalhando com bases de código existentes.

### 🤖 Riscos e Segurança da IA

- [⚠️ Uma Década de Advertências Sobre IA: 2014-2025](./ai-warnings-decade-timeline-experts.md) - Cronologia detalhada das advertências de especialistas como Hinton, Russell e Bengio sobre os riscos da IA.
- [🚨 AI Experts Warnings: 2023-2025](./ai-safety-expert-warnings-2023-2025.md) - Compilation of recent urgent warnings from leading AI researchers like Geoffrey Hinton, Yoshua Bengio and others.
- [🕸️ Melhores Web Crawlers Node.js para Agentes de Código em 2025](./nodejs-web-crawlers-code-agents-2025.md) - Comparativo detalhado entre Crawlee, Playwright, Node-Crawler e X-Ray para extração de dados.
...
- [📋 Checklist Essencial: Perguntas que IAs Devem Fazer Antes de Escrever Código](./ai-coding-essential-questions-checklist.md) - Conjunto abrangente de perguntas em 8 categorias fundamentais que modelos de IA devem considerar para gerar código robusto.
- [🖱️ Como usar DeepSeek no Cursor](./deepseek-models-cursor-editor-setup.md) - Guia para configurar e usar os modelos DeepSeek no editor
  Cursor.
- [💻 Edição de Código TypeScript com LLM](./typescript-code-editing-llm-ts-morph.md) - Sistema para
  geração e edição de código usando LLMs.

### 🔊 Áudio, Voz e Interfaces Conversacionais

- [🎧 Ciência do Som: Áudio para Hiperfoco em Programadores com Bipolaridade](./audio-science-hyperfocus-bipolar-programmers-pt.md) - Análise científica para otimização de ambientes sonoros para programadores com bipolaridade e alto QI.
- [🎙️ APIs de Diarização e Reconhecimento de Falantes](./commercial-voice-diarization-recognition-apis.md) -
  Comparativo de APIs para processamento de voz.
- [📱 Roadmap: App Android de Streaming de Áudio](./android-audio-streaming-app-roadmap.md) -
  Desenvolvimento de aplicativo para captura de áudio no Android.
- [📲 Roadmap: App iOS React Native para Áudio](./ios-react-native-audio-app-development-roadmap.md) -
...
- [📊 Templates para Aplicações Financeiras](./responsive-templates-financial-stock-applications.md) -
...
- [📉 Indicadores Relevantes para Ações](./stock-market-relevant-indicators-guide.md) - Indicadores técnicos para análise de
  ações.
- [🧠 Análise Gráfica com TensorFlow](./stock-technical-analysis-tensorflow.md) - Modelos de IA para análise de
  gráficos de ações.
- [💹 Automatizando Investimentos na B3](./b3-stock-automation-react-developer-guide.md) - Guia para
  desenvolvedores React.js criarem soluções de automação de investimentos.
- [💰 Guia de Migração para Criptomoedas](./crypto-banking-migration-privacy-guide.md) - Migração do banco
...
- [🔍 Anti-Detecção em Automação Web](./undetectable-browser-automation-frameworks.md) - Ferramentas para automação
  web evitando detecção.
- [🔒 Guia de Anonimato na Internet](./internet-anonymity-privacy-guide.md) - Técnicas de privacidade e
  anonimato online.
- [📦 XMind: Implementação de Pacote npm](./xmind-npm-package-implementation.md) - Criar pacote npm para mapas XMind com dados
  de LLMs.

### 🎓 Educação e Pesquisa Acadêmica

- [📚 Serviços de Acesso a Artigos Científicos](./scientific-papers-access-services.md) - Serviços para acesso a
  artigos acadêmicos.
- [🎓 Métodos Pedagógicos e "Professor Perfeito"](./optimal-teaching-methods-perfect-tutor.md) - Métodos pedagógicos e
  tutores inteligentes.
- [🧠 Educação em IA no Brasil](./ai-education-brazil-online-courses-comparison.md) - Cursos de IA no formato EAD no Brasil.
